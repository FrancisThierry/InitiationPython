...
prixFlotte = (452566,566688,566688,0,155,11)
nomVoitures = ("Ford B Max", "Audi TT", "Audi TT")
nomVoituresMixPrix = ("Ford B Max", "Audi TT", 15888)

# autorise les dupplicats
print(nomVoitures)

print(prixFlotte)

print(nomVoituresMixPrix)
# tva = 0.2
# primeEco = 0.05
...
#     prixTTCVoiture = prixTTC(prixVoiture, tva)
...
#     print("i :",i)
#     prixTTCVoiture = prixTTC(prixFlotte[i], tva)
#     print("Prix TTC : {0}".format(prixTTCVoiture))
